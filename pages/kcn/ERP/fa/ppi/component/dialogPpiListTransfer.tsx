...
dialogPpiListTransferProps) => {
            ...
            try {
                if (masterDataState == 'BARU') {
                    ...
                    await fetchPreferensi(kode_entitas, apiUrl)
                        .then((result) => {
                            console.log('fetchPreferensi = ', result);
                            setStateDataHeader((prevState: any) => ({
                                ...prevState,
                    ...
                    console.log('resultListEditPPIMaster = ', resultListEditPPIMaster);
    ...
    const prosesBloking = async () => {
        ...
        if (dataJurnal.nodes.length > 0) {
            ...
            console.log('totalDebet = ', totalDebet.toFixed(2), totalKredit.toFixed(2));
        ...
        console.log('totalDebet = ', stateDataDetail.totalDebet, stateDataDetail.totalKredit, stateDataDetail.totalDebet.toFixed(2), stateDataDetail.totalKredit.toFixed(2));
