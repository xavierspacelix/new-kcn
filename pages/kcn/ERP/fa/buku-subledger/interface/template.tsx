...
const ConvertDataToHtml = (data: any, objectToExcel: any) => {
    ...
    <h4>
${objectToExcel.kode_entitas}<br/>
        ${objectToExcel.no_akun}<br/>
        ${objectToExcel.no_subledger}
    </h4>
...
export { ConvertDataToHtml, SumDebet, SumKredit, TotDebKre, SumSaldoKumulatif, CustomSumDeb, CustomSumKre, CustomSumSaldoKumulatif, CustomTotDebKre, swalToast, TemplateNamaAkun, TemplateNoAkun };
